...
class CollapsibleListItem extends React.Component {
  ...
  render () {
    const { children, showSeparator, containerStyle, ...rest } = this.props;
    return (
      <Col alignItems='stretch' style={containerStyle}>
        <ListItem
          {...rest}
        ...
        <Animated.View
          ref={this.setRef}
          style={{ height: this.state.collapsibleHeight, overflow: 'hidden' }}>
          {children}
        </Animated.View>
